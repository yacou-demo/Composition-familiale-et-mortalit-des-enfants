...
label define eventlab 1 "ENU" 2 "BTH" 3 "IMG" 4 "OMG" 5 "EXT" 6 "ENT" ///
	7 "DTH" 80 "-3mDTH" 89 "+3mDTH" 9 "OBE" 10 "DLV" 11 "PREGNANT" 18 "OBS" 19 "OBL" 20 "1Jan" 21 "NewAgeGroup", modify
...
label define eventlab 1 "ENU" 2 "BTH" 3 "IMG" 4 "OMG" 5 "EXT" 6 "ENT" ///
	7 "DTH" 80 "-6mDTH" 81 "-3mDTH" 82 "+3mDTH" 87 "+15dDTH" 88 "+3mDTH"  89 "+3mDTH" ///
...
save residency_sahel_101120,replace
...
use final_dataset_analysis_des_p3_bis_011120,clear
...
save twin_sahel_011120, replace
...
append using non_twin_sahel_011120
...
save twin_sahel_bis_011120, replace
erase non_twin_sahel_011120.dta
...
rename ChildId concat_IndividualId
sort concat_IndividualId
save ysibling_sahel_011120, replace
...
rename ChildId concat_IndividualId
sort concat_IndividualId
save non_ysibling_sahel_011120, replace
...
order concat_IndividualId
append using non_ysibling_sahel_011120
...
rename ChildId concat_IndividualId
sort concat_IndividualId
save osibling_sahel_011120, replace
...
rename ChildId concat_IndividualId
sort concat_IndividualId
save non_osibling_sahel_011120, replace

*Merge the file of older siblings with the core residency file to get their event history:
use residency_sahel_101120, clear

sort concat_IndividualId
merge m:1 concat_IndividualId using osibling_sahel_011120.dta
keep if _merge==3
drop _merge
...
order concat_IndividualId
append using non_osibling_sahel_011120
...
save osibling_sahel_011120,replace
erase non_osibling_sahel_011120.dta
...
clear
capture erase child_network_twin_sahel_011120.dta
tmerge concat_IndividualId final_dataset_analysis_des_p3_bis_011120(EventDate) twin_sahel_bis_011120(EventDateTwin) ///
		child_network_twin_sahel_011120(EventDate_final)
...
sort concat_IndividualId EventDate EventCode
save child_network_twin_sahel_011120, replace

*Merge the file of younger siblings with the children file that already includes parents’ and twin’s history:
clear
capture erase child_network_t_y_sahel_011120.dta
tmerge concat_IndividualId child_network_twin_sahel_011120(EventDate) ysibling_sahel_011120(EventDateY) ///
child_network_t_y_sahel_011120(EventDate_final)
...
order concat_IndividualId EventDate EventCode
sort concat_IndividualId EventDate EventCode
save child_network_t_y_sahel_011120, replace

*Merge the file of older siblings with the children file that includes parents’ and younger siblings’ histories:
clear
capture erase child_network_sibling_sahel_011120.dta
tmerge concat_IndividualId child_network_t_y_sahel_011120 (EventDate) osibling_sahel_011120(EventDateO) ///
child_network_sibling_sahel_011120(EventDate_final)
...
save child_network_sibling_sahel_011120,replace
